  ...
  return (
    <aside className={`fixed right-0 top-16 h-[calc(100vh-4rem)] bg-white dark:bg-gray-800 shadow-xl border-l border-gray-200 dark:border-gray-700 transition-all duration-300 z-40 ${
      ...
      <button
        ...
        className="absolute -left-3 top-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full p-1 shadow-lg hover:shadow-xl transition-all"
      >
        {collapsed ? (
              ...
              if (item.external) {
                return (
                  <button
                    ...
                    className={`flex items-center space-x-3 space-x-reverse px-3 py-3 rounded-lg transition-all duration-200 group w-full text-right ${
                      item.highlight
