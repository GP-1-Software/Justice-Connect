...
const ClientDetailsBox = ({ clientIdNumber }) => {
  ...
  const fetchClientDetails = async () => {
    try {
      ...
      // Fetch client data from users table using id_number
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-800 dark:to-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-5 lg:p-6">
