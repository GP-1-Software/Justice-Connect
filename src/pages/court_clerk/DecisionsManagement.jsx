...
const DecisionsManagement = () => {
    ...
    const fetchAllDecisionsForCases = async () => {
        try {
            ...
            for (const caseItem of cases) {
                const response = await fetch(`https://justice-connect-mobile.onrender.com/api/court-clerk/cases/${caseItem.case_id}/decisions`, {
                    headers: getAuthHeaders()
                });
                if (response.ok) {
                    const data = await response.json();
    ...
    const fetchDecisions = async (caseId) => {
        try {
            const response = await fetch(`https://justice-connect-mobile.onrender.com/api/court-clerk/cases/${caseId}/decisions`, {
                headers: getAuthHeaders()
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const handleIssueDecision = async (e) => {
        ...
        try {
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/cases/${selectedCase.case_id}/decisions`,
                {
                    method: 'POST',
                    headers: getAuthHeaders(),
