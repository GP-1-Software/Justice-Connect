...
const AppealsManagement = () => {
    ...
    const fetchAppeals = async (showRefresh = false) => {
        try {
            ...
            const response = await fetch('https://justice-connect-mobile.onrender.com/api/court-clerk/appeals', {
    ...
    const fetchAppealDetails = async (appealId) => {
        try {
            const response = await fetch(`https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${appealId}`, {
                headers: getAuthHeaders()
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const handleReviewSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${selectedAppeal.appeal_id}/review`,
                {
                    method: 'POST',
                    headers: getAuthHeaders(),
    ...
    const handleTransferSubmit = async () => {
        ...
        try {
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${selectedAppeal.appeal_id}/transfer`,
                {
                    method: 'POST',
                    headers: getAuthHeaders(),
    ...
    const handleScheduleHearing = async () => {
        ...
        try {
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${selectedAppeal.appeal_id}/schedule-hearing`,
                {
                    method: 'POST',
                    headers: getAuthHeaders(),
    ...
    const handleIssueDecision = async () => {
        ...
        try {
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${selectedAppeal.appeal_id}/decision`,
                {
                    method: 'POST',
                    headers: getAuthHeaders(),
    ...
    const handleCloseCase = async () => {
        try {
            setClosingCase(true);
            const response = await fetch(
                `https://justice-connect-mobile.onrender.com/api/court-clerk/appeals/${selectedAppeal.appeal_id}/close`,
                {
                    method: 'POST',
                    headers: getAuthHeaders()
                }
