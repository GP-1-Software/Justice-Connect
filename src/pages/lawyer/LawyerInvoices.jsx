      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-2">إدارة جميع الفواتير والمدفوعات</p>
            </div>
            <button
            ...
            {statsCards.map((stat, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500">{stat.count} فاتورة</span>
                </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">ابدأ بإنشاء فاتورة جديدة لعملائك</p>
            <button
              onClick={() => navigate('/lawyer/invoices/create')}
