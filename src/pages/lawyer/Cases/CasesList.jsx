            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-stretch sm:items-center">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pr-9 pl-3 py-2 sm:py-3 text-sm border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm appearance-none cursor-pointer"
                >
