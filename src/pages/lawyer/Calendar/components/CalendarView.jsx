          ...
          {days.map((date, index) => {
            ...
            return (
              <div
                ...
                className={`min-h-32 p-2 rounded-lg border relative cursor-pointer transition-all hover:shadow-md ${date
                    ? isTodayDate
                ...
                {date && (
                  <>
                    <div className="flex items-center justify-between mb-1">
                      <div className={`text-sm font-semibold ${isTodayDate ? 'text-blue-600' : 'text-gray-900 dark:text-white'
                        }`}>
                        {date.getDate()}
                      </div>
                      {isOff && (
