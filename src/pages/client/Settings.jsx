...
const Settings = () => {
  const { userProfile, changePassword } = useClientAuth();
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Tabs */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl mb-6 border border-gray-100 dark:border-gray-700">
        <div className="border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
          <nav className="flex space-x-2 sm:space-x-4 px-4 sm:px-6 min-w-max" aria-label="Tabs">
            {[
              { id: 'security', name: 'الأمان', icon: <Shield className="h-4 w-4" /> },
              { id: 'notifications', name: 'الإشعارات', icon: <Bell className="h-4 w-4" /> },
              { id: 'account', name: 'إدارة الحساب', icon: <Trash2 className="h-4 w-4" /> }
            ].map((tab) => (
              <button
                key={tab.id}
        ...
        {activeTab === 'notifications' && (
          <form onSubmit={handleNotificationUpdate} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">تذكير بالمواعيد</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">تلقي تذكير قبل المواعيد</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">تحديثات القضايا</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">تلقي إشعارات عن تحديثات القضايا</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">رسائل تسويقية</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">تلقي عروض وأخبار المنصة</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
