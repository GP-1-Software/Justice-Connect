      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 pb-8 border-b border-gray-200">
            {/* Lawyer Info */}
            <div>
              <h3 className="text-sm font-semibold text-gray-500 mb-3">معلومات المحامي</h3>
              <div className="space-y-2">
                ...
                {invoice.lawyer?.email && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600">{invoice.lawyer.email}</span>
                  </div>
                )}
                {invoice.lawyer?.phone && (
                  <div className="flex items-center gap-2">
                    <Phone className="w-4 h-4 text-gray-400" />
                    <span className="text-gray-600">{invoice.lawyer.phone}</span>
                  </div>
                )}
              </div>
            </div>
